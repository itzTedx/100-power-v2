...
<Section>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>Yellowish clear</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Smell</TableCell>
      <TableCell>Odorless</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>pH-value (T=23 ºC)</TableCell>
      <TableCell>Not determined</TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      <TableCell>Boiling Point / Range</TableCell>
      <TableCell>&gt; 300 °C</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Flashpoint (open cup)</TableCell>
      <TableCell>&gt; 153 °C (307 °F)</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Self-inflammability</TableCell>
      <TableCell>Not determined</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Vapor Density (T=20 ºC)</TableCell>
      <TableCell>Heavier than air</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Vapor Pressure (T=20 ºC)</TableCell>
      <TableCell>1 mmHg</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Evaporation Point</TableCell>
      <TableCell>Higher than ether</TableCell>
    </TableRow>
  </TableBody>
</Table>
