...
title: POWER 5W30
images:
    - /images/products/regular/5w30-regular.jpg
quantities:
    - 1 L
    - 4 L
    - 5 L
...
meta:
  title: POWER 5W30 Fully Synthetic Engine Oil – API SP Motor Oil for Modern Engines
  description: Experience POWER 5W30, a high-performance fully synthetic motor oil formulated to meet API SP standards. Engineered for enhanced fuel efficiency, superior wear protection, and reliable cold start performance. Ideal for vehicles with start-stop technology and extreme temperature conditions.
---
