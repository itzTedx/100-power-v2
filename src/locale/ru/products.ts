export default {
  breadcrumb: {
    ...
    categories: {
      ...
      lubrication: "Смазочные материалы",
  ...
  aviation: {
    ...
    options: {
      all: "Все продукты",
      piston: "Масла для поршневых двигателей",
      turbine: "Масла для турбинных двигателей",
      hydraulic: "Гидравлические жидкости",
      gear: "Трансмиссионное масло",
    },
  },
