export default {
  hero: {
    ...
    title: {
      text: "Advanced Additives for Peak Performance and Lasting",
  ...
  about: {
    ...
    title: {
      first: "We develop",
      highlight: "eco-friendly, high-performance",
      last: "additives that protect your vehicle and extend its life for a better future.",
    },
    description:
      "We are 100 Power, bringing a new era of performance with advanced solutions built for the engines of the future.",
    button: "Learn More",
  },
  video: {
    play: "Play Video",
  ...
  industries: {
    ...
    title: "Serving Every Sector with Precision",
    description: {
      first: "From",
      highlight: "engines to excavation,",
      last: "we power the industries where friction hurts most and performance matters most.",
    },
    industry: [
      { label: "Automotive" },
      { label: "Railways" },
  ...
  technologies: {
    badge: "Our Core Technologies",
    title: {
      first: "Built for",
      highlight: "Performance.",
      last: "Powered by Responsibility",
    },
    description:
