export default {
  hero: {
    title: "Smarter Lubrication. Longer Life. Greener Impact.",
    description:
      "We engineer advanced solutions that protect, optimize, and extend the life of engines and machinery using proprietary Micro-Metallurgical Technology.",
    button: "Explore Products",
  },
  technologies: "Our Core Technologies",
  certified: {
    badge: "USA-Certified",
    title: "Engineered with Certified U.S. Technology",
    description:
      "We proudly incorporate Anti-Friction Technology developed in the USA, ensuring unmatched quality, reliability, and innovation. This badge represents our commitment to world-class performance and engineering excellence in lubrication science.",
    list: {
      one: "Certified Micro-Metallurgical Process",
      two: "Made to U.S. Standards",
      three: "Trusted in Industrial & Military Applications",
    },
  },
  benefits: {
    badge: "Benefits",
  ...
  results: {
    ...
    title: `Real Results.
      Real Impact.`,
    description:
      "100 Power improves uptime, reduces costs, and enhances performance — powered by advanced U.S. anti-friction technology.",
    table: {
      title: {
        without: "Without 100 Power",
        with: "With 100 Power",
      },
      row: {
        downtown: {
          ...
          with: "Extended uptime",
        },
        maintenance: {
          title: "Maintenance Cost",
          without: "High and recurring",
          with: "Reduced significantly",
        },
        performance: {
          title: "Performance Consistency",
          without: "Inconsistent and inefficient",
          with: "Smooth, long-term consistency",
        },
      },
    },
  },
